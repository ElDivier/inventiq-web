...
export default function SplashScreen() {
  return (
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-cyan-950 via-sky-800 to-cyan-500 p-6">
      <div className="text-center text-white">
        ...
        <p className="mt-2 text-sm font-semibold text-cyan-100">Control inteligente de inventarios</p>
